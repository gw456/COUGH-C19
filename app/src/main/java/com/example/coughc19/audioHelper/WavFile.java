        ...
        while (true) {
            ...
            if (chunkID == FMT_CHUNK_ID) {
                ...
                if (wavFile.numChannels == 0)
                    throw new WavFileException("Number of channels specified in header is equal to 0");
                if (wavFile.blockAlign == 0)
                    throw new WavFileException("Block Align specified in header is equal to 0");
                if (wavFile.validBits < 2) throw new WavFileException("");
                ...
                if (wavFile.bytesPerSample * wavFile.numChannels != wavFile.blockAlign)
                    throw new WavFileException("Bytes required for validBits and number of channels");
