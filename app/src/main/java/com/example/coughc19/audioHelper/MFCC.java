...
public class MFCC {
    ...
    private static int mfcc_ammount = 40;
    private final static double fMin = 0.0;
    private final static int mels = 128;
    ...
    private double[][] dctMfcc(double[] y) {
        ...
        final double[][] dctBasis = dctFilter(mfcc_ammount, mels);
        double[][] mfccSpecTro = new double[mfcc_ammount][specTroGram[0].length];
        for (int i = 0; i < mfcc_ammount; i++) {
    ...
    private double[][] melFilter() {
        ...
        final double[] melF = melFreq(mels + 2);
        ...
        double[][] weights = new double[mels][1 + n_fft / 2];
